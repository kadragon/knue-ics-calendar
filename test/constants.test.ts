...
import { HOLIDAYS, CALENDAR_CONFIG, REQUEST_CONFIG, CACHE_CONFIG } from '../src/constants';
...
describe('Constants', () => {
  ...
  describe('CALENDAR_CONFIG', () => {
    it('should have correct calendar configuration', () => {
      ...
      expect(CALENDAR_CONFIG.prodId).toBe('-//Github@kadragon//knue-ics-calendar//KO');
      expect(CALENDAR_CONFIG.timezone).toBe('Asia/Seoul');
      expect(CALENDAR_CONFIG.url).toBe('https://github.com/kadragon/knue-ics-calendar');
    });
